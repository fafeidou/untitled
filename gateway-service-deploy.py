...
def restartService():
    execmd = "cd /home/ckitadmin/ck-project/ && ./gateway-restart.sh "
...
if __name__ == '__main__':
    # 打包
    os.system(
        "cd C:\idea_work\git\ck-admin-gateway && mvn clean package && cd ./target &&  mkdir jar && move .\ck-admin-gateway-0.0.1-SNAPSHOT.jar .\jar")
    local_dir = r'C:\idea_work\git\ck-admin-gateway\target\jar'
